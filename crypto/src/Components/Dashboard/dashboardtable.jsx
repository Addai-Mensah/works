...
function Dashboardtable() {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-8 mt-[5rem]">
      <div className="py-8">
        <div>
          <h2 className="md:text-2xl text-[1.2rem] font-semibold text-[#00000095] leading-tight">React real-time animated ranking table for Cryptocurrencies</h2>
        </div>

...
function Managefunds() {
  return (
    <div>
      ...
      <div>
        <p className='md:text-[3rem] leading-14 md:w-[40rem] w-[100vw] text-[2rem]  md:mt-[4rem] '>Control your security completely with one centralized dashboard.</p>
          <p className='md:w-[25rem] md:mt-[2rem] mt-[1rem] text-[1.2rem] '>Our website has HTTPS encryption, robust firewall and we always ensure reqular security update</p>
